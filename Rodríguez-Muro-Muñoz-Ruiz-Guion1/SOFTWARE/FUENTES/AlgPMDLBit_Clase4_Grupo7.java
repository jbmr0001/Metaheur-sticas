 ...
 * @author Grupo 7
 */
public final class AlgPMDLBit_Clase4_Grupo7 {
     ...
     */
    public AlgPMDLBit_Clase4_Grupo7(int tam, int[][] MFlujo, int MDistancia[][], LinkedList<Integer> solucionInicial, int numIt) {
        this.tamTotal = tam;
        this.MF = MFlujo;
        this.MD = MDistancia;
